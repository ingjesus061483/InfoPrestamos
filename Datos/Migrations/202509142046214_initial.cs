namespace Datos.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Codigo = c.String(nullable: false, maxLength: 50),
                        Fecha = c.DateTime(nullable: false),
                        Couta = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Interes = c.Decimal(nullable: false, precision: 18, scale: 2),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Cuotas", "PrestamoId", "dbo.Prestamos");
            ...
            DropForeignKey("dbo.Pagos", "CuotaId", "dbo.Cuotas");
            ...
            DropIndex("dbo.Pagos", new[] { "CuotaId" });
